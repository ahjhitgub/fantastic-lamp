  ...
  async render(container) {
    container.innerHTML = `
      ...
      <div class="coming-next">
        <strong>Already available elsewhere:</strong> every transfer WC has printable IRR, weight certificate, purchase invoice and 197 documents (Documents section of the WC), and the Residuals page shows the 196B §IV and §V numbers for any month.<br><br>
