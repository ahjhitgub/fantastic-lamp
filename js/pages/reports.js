  ...
  async render(container) {
    container.innerHTML = `
      ...
      <div class="coming-next">
        <strong>Already available elsewhere:</strong> every transfer WC has a printable 197 preview, and the Residuals page shows the 196B §IV and §V numbers for any month.<br><br>
